...
yes 12345678 | injectived tx wasm execute inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$USER_STAKE" --from=$(echo $INJ_ADDRESS) \
--chain-id="injective-888" \
...
injectived query wasm contract-state smart inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$GET_USER_STAKE" \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json 

# User unstake from contract
USER_UNSTAKE='{"user_unstake":{"amount":"50"}}'
yes 12345678 | injectived tx wasm execute inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$USER_UNSTAKE" --from=$(echo $INJ_ADDRESS) \
--chain-id="injective-888" \
--yes --fees=1000000000000000inj --gas=2000000 \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json
...
INCREASE_ALLOWANCE='{"increase_allowance":{"spender": "inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a", "amount":"20", "expires": null}}'
...
ALLOWANCE_QUERY='{"allowance": {"owner": "inj19r9a7jxj5d2mh7487a4rtn32d6l5mq5zf6tm2g", "spender": "inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a"}}'
...
yes 12345678 | injectived tx wasm execute inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$AGENT_STAKE" --from=$(echo $AGENT_INJ_ADDRESS) \
--chain-id="injective-888" \
--yes --fees=1000000000000000inj --gas=2000000 \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json
...
injectived query wasm contract-state smart inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$GET_AGENT_STAKE" \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json 

# Agent unstake to contract
AGENT_UNSTAKE='{"agent_unstake":{"amount":"10"}}'
yes 12345678 | injectived tx wasm execute inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$AGENT_UNSTAKE" --from=$(echo $AGENT_INJ_ADDRESS) \
--chain-id="injective-888" \
--yes --fees=1000000000000000inj --gas=2000000 \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json
...
yes 12345678 | injectived tx wasm execute inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$DISTRIBUTE_REWARDS_BY_AGENT" --from=$(echo $INJ_ADDRESS) \
--chain-id="injective-888" \
--yes --fees=1000000000000000inj --gas=2000000 \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json
...
yes 12345678 | injectived tx wasm execute inj1nuz563eeg7lgv2lr5stfj92tcj347zf7rvm07a "$DISTRIBUTE_REWARDS_BY_TIME" --from=$(echo $INJ_ADDRESS) \
--chain-id="injective-888" \
--yes --fees=1000000000000000inj --gas=2000000 \
--node=https://testnet.sentry.tm.injective.network:443 \
--output json